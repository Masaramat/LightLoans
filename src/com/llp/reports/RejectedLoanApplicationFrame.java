...
public class RejectedLoanApplicationFrame extends JFrame {
	...
	public RejectedLoanApplicationFrame() throws RemoteException{
		...
		JLabel lblApplicationStatus = new JLabel("Rejection Status");
		...
		statusBox.setModel(new DefaultComboBoxModel(new String[] {"All", "Returned", "Rejected", "Blocked"}));
		...
		btnPreview.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					ArrayList<RejectedLoan> listt = reportInterface.getRejectedLoansReport(column_list, data_list, sqlfromDate, sqltoDate);
					if(listt.size() == 0) {
						JFrame jf = new JFrame();
						jf.setAlwaysOnTop(true);
						JOptionPane.showMessageDialog(jf, "No results found!");
					}else {
						LoanReportsShowFrame frame = new LoanReportsShowFrame("rejected_loans", column_list, data_list, sqlfromDate, sqltoDate);
						frame.setVisible(true);
					}
